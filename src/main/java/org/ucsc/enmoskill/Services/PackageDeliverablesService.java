    ...
    public int insertPackageDeliverables(PackagePricing pricing){
        ...
        try{
            ...
            query = "INSERT INTO price_package_deliverables"+
                    "(deliverables_id, price_package_id, category, del_1, del_2, del_3, del_4, del_5) "+
                    "VALUES(?,?,?,?,?,?,?,?)";
            preparedStatement = con.prepareStatement(query);
            preparedStatement.setInt(1, pricing.getDel().getDeliverablesId());
            preparedStatement.setInt(2, pricing.getDel().getPricePackageId());
            preparedStatement.setInt(3, pricing.getDel().getCategoryId());
            preparedStatement.setInt(4, pricing.getDel().getDel_1());
            preparedStatement.setInt(5, pricing.getDel().getDel_2());
            preparedStatement.setInt(6, pricing.getDel().getDel_3());
            preparedStatement.setInt(7, pricing.getDel().getDel_4());
            preparedStatement.setInt(8, pricing.getDel().getDel_5());
